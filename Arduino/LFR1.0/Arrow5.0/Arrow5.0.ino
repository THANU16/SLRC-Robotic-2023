...
void useFront(){
  if(irReadings[5] == 1 && irReadings[7] == 0 && irReadings[8] == 0){
    useBack();

  }else if((irReadings[7] == 0 && irReadings[8] == 1 && irReadings[5] == 0) || (irReadings[7] == 0 && irReadings[8] == 1 && irReadings[5] == 1)){
    turnRight();
   
  }else if((irReadings[7] == 1 && irReadings[8] == 0 && irReadings[5] == 0) || (irReadings[7] == 1 && irReadings[8] == 0 && irReadings[5] == 1)){
    turnLeft();
